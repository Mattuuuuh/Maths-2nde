...
\ex{Somme de vecteurs géométriquement}{
	Soient ${\color{RED_E} u} = \pvec{2}{-1}$ et ${\color{BLUE_E} v}= \pvec{-3}{-2}$ deux vecteurs.
...
\pf{}{
	...
	\end{align*}
	Appliquer la racine carré conclut en se remémorant que $\sqrt{\kappa^2} = |\kappa|$.
}
...
{
	Par homogénéité, l'équation est équivalente à
		\begin{align*}
...
Le translaté de $A$ par $v$ est noté $A+v$ et est représenté ci-contre.
	...
	\begin{center}
	\includegraphics[page=12]{figures/fig-vecteurs.pdf}
	\end{center}
\end{multicols}
	
\begin{multicols}{2}
Le translaté de $A+v$ par $v$ est $(A+v)+v = A+2v$, représenté ci-contre.

De façon similaire, on représente les translatés $A-v$, $A+1,5v$, $A - \frac{\pi}{6} v$ ci-dessous.
	\begin{center}
	\includegraphics[page=13]{figures/fig-vecteurs.pdf}
	\end{center}
\end{multicols}


	\begin{center}
	\includegraphics[page=14]{figures/fig-vecteurs.pdf}
	\end{center}
...
\nomen{
	Cette droite ainsi créée est appelée la droite passant par $A$ et \emph{dirigée} par $v$, le vecteur $v$ donnant sa direction.
}
...
\nt{
	...
	En outre, si $v$ dirige $(d)$, alors n'importe quel multiple non nul de $v$ aussi : $2v, -3,14v$, etc...
}
...
\thm{}{
	...
	Alors $\det(u, v) = 0$ si et seulement si les vecteurs $u$ et $v$ sont colinéaires.
}{}
...
\exe{, difficulty=2}{
	...
	Au regard de l'exercice \ref{exe:det-is-signedvolume}, l'interprétation géométrique est la suivante : pour des côtés de longueurs fixées, l'aire d'un parallélogramme est maximale lorsqu'il est rectangle.
}{exe:Hadamard}{
