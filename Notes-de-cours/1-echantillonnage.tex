...
C'est de là que vient l'interprétation de la variance donnée dans le chapitre \ref{chap:statistiques}.
...
\exe{}{
	...
	\begin{tabular}{|c|c|c|c|} \hline
		...
		Nombre de tirages & 3 223 & 4 909 & 1 638 \\ \hline
		Fréquence &  &  &   \\ \hline
	\end{tabular}
	\end{center}
	...
	Les fréquences sont calculées à $10^{-2}$ près dans le tableau suivant.
	
	\begin{center}
	\begin{tabular}{|c|c|c|c|} \hline
		Couleur & Rouge & Bleu & Vert \\ \hline
		Nombre de tirages & 3 223 & 4 909 & 1 638 \\ \hline
		Fréquence &  $0,33$   &  $0,50$  &  $0,16$  \\ \hline
	\end{tabular}
	\end{center}
...
\exe{}{
	...
	\begin{tabular}{|c|c|c|c|c|c|c|} \hline
		...
		Nombre de tirages & 20 543 & 30 480& 10 048 & 15 338 & 20 223 & 5 082 \\ \hline
		Fréquence & &  &  & & & \\ \hline
	\end{tabular}
	\end{center}
	...
	\begin{tabular}{|c|c|c|c|c|c|c|} \hline
		Face & 1 & 2 & 3 & 4 & 5 & 6 \\ \hline
		Nombre de tirages & 20 543 & 30 480& 10 048 & 15 338 & 20 223 & 5 082 \\ \hline
		Fréquence & $ 0,2$ & $ 0,3$ & $ 0,1$ & $ 0,15$ & $ 0,2$ & $ 0,05$ \\ \hline
	\end{tabular}
	\end{center}
