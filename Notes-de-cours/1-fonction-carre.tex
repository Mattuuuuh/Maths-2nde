...
\nt{
	L'étude des variations et des extrema de fonctions fera l'objet du chapitre \ref{chap:variations}.
}
...
\exe{}{
	Montrer, sans calculatrice, que $\sqrt{7^{3782}} =7^{1891}$.
}{exe:sqrt8}{
	TODO
}

\exe{}{
	Est-ce que l'égalité suivante tient ? $\sqrt{(-2)^{26}} =(-2)^{13}$.
}{exe:sqrt9}{
	TODO
}
...
\ex{}{
	...
	En voyant l'un des $(x-4)$ comme un tout, et l'autre comme un somme de deux quantités, $x$ et $-4$, il
...
% à mettre dans le chapitre 2 peut-être ?
% c'est pas intéressant ici
%\mprop{}{
...
%
%\nt{
%	En voyant $\frac{a+b}2$ comme $\frac12 a + \frac12 b$, on peut comprendre le milieu comme une moyenne de deux valeurs ($a$ et $b$).
%	C'est d'ailleurs comme ça qu'on calcule une moyenne de notes ayant le même coefficient --- leur poids est alors $\frac12$.
...
%	Par exemple, si $a$ compte deux fois plus que $b$, les coefficients seront (par exemple) $2$ et $1$, et les poids $\frac23$ et $\frac13$.
