...
\ex{forme canonique : du signe du carré à l'extremum}{
	...
	Multiplier par $-1$ rend la quantité négative et on obtient, en ajoutant $\dfrac{265}2$,
		\begin{align*}
...
\exe{, difficulty=1}{
	Soit $f$ la fonction définie sur $\R$ par
		\[ f(x) = -10 + 3(3x-1)^2. \]
	Montrer que $f$ atteint son minimum en $x^\star=\dfrac13$ et donner sa valeur.
}{exe:extrema4-99}{
...
\exe{, difficulty=2}{
	...
	Nous cherchons le point de $\C_f$ le point proche de $A$.
	\begin{enumerate}
		\item
		Grapher $\C_f$ sur le domaine $[0 ; 4]$, et placer le point $A$ dans le même repère.
