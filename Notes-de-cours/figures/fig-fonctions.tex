...
%
	...
	% exe:graph-droite
	\begin{tikzpicture}[>=stealth]
		\begin{axis}[xmin = -5.5, xmax=3.5, ymin=7.5, ymax=-3.5, axis x line=middle, axis y line=middle, axis line style=->, grid=both]
	...
	\begin{tikzpicture}[>=stealth]
		...
		\addplot[domain=-3:3, samples=100, BLUE_E, very thick] {atan(x*2)/40} node[pos=.8, above] {$\C_f$};
		\addplot[domain=-3:3, samples=100, RED_E, very thick] {atan(x*2)/40+2} node[pos=.2, above] {$\C_g$};
		\addplot[domain=-3:3, samples=100, GREEN_E, very thick] {atan(x*2)/40-1} node[pos=.2, below] {$\C_h$};
		\end{axis}
	\end{tikzpicture}
	...
	\begin{tikzpicture}[>=stealth]
		...
		\addplot[domain=-3:3, samples=100, BLUE_E, very thick] {atan(x*2)/40} node[pos=.8, above] {$\C_f$};
		\addplot[domain=-3:3, samples=100, RED_E, very thick] {2*atan(x*2)/40} node[pos=.8, above] {$\C_g$};
		\addplot[domain=-3:3, samples=100, GREEN_E, very thick] {-2*atan(x*2)/40} node[pos=.8, above] {$\C_h$};
		\end{axis}
	\end{tikzpicture}
%
\end{document}