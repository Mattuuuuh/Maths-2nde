...
\exe{[6pts]
	...
	\begin{enumerate}
		...
		\item 
			\[ \C_f \cap \C_g = \left\{ \left( 0 ; 1 \right) \right\}. \]
		\item 
			\[ \C_f \cap \C_g = \left\{ \left( -\dfrac17 ; 2 \right) \right\}. \]
		\item 
			\[ \C_f \cap \C_g = \left\{ \left( -8 ; 25 \right) \right\}. \]
		\item 
			\[ \C_f \cap \C_g = \C_f = \C_g. \]
		\item 
...
\exe{
	...
	Comme la valeur absolue supprime le signe, on a $4$ possibilités de signes qui impliquent deux équations distinctes à résoudre.
		\begin{align*}
