...
\exe{,difficulty=1}{
	...
	\begin{enumerate}
		...
		\begin{enumerate}
			...
			Comme $\vec{AB} = \pvec{\ux}{\uy}$ et $\vec{AD} = \wmult\pvec{\wx}{\wy}$, on justifie soit en disant que $\vec{AD} = \fourier \vec{AB}$, soit en calculant \mbox{$\det\bigl(\vec{AD}, \vec{AB}\bigr) = 0$.}
			\item
