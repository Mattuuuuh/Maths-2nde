...
\exe{}{
	Un magasin augmente frauduleusement ses prix avant d'appliquer une remise de $\REMISE\%$.
	On compare les prix initiaux avant augmentation aux prix finaux après application des deux évolutions.
	
	Répondre aux questions suivantes en arrondissant les valeurs numériques à $10^{-2}$ et les pourcentages à l'unité.
	\begin{enumerate}
		\item 
