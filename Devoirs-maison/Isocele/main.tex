...
}{exe:1}
{
	\begin{center}
	\begin{tikzpicture}
	\begin{axis}[xmin=\xmin, xmax=\xmax, ymin=\ymin, ymax=\ymax, axis x line=middle, axis y line=middle, axis line style=<->, xlabel={}, ylabel={}, grid=both, grid style = {opacity=.5}, unit vector ratio=*1 1, width=20cm, height=6cm]
