...
%% THEN RUN THIS
%\input{preamble.tex}\input{adr/vars_12345.adr}

\pagestyle{fancy}
\fancyhead[L]{Seconde}
\fancyhead[C]{\textbf{Approfondissements -- \seed \ifsolutions \, -- Solutions  \fi}}
\fancyhead[R]{\today}
...
\exe{
	 ...
	 En déduire que $[BP]$ est la hauteur du triangle $OAB$ de base $[OA]$.
}{
