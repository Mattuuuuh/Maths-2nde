...
\exe{}{
	...
	$I$ est placé sur $(OA)$ tel que $(OI)$ et $(OA)$ soient perpendiculaires.
...
\exe{}{
	...
	Dans le triangle $OBI$ rectangle en $I$, la trigonométrique nous donne
		\[ \sin(\alpha) = \dfrac{BI}{OB} = \dfrac{h}{\l}. \]
	En multipliant par $\l$, on obtient bien $h = \l\sin(\alpha)$.
...
\exe{}{
	...
	Nous cherchons donc le maximum de la fonction $f$ suivante.
		\[ f(\alpha ) = \arctan\Bigl(\dfrac{\l \sin(\alpha)}{\L - \l \cos(\alpha)}\Bigr) \]
	...
	\begin{enumerate}
		...
		\item
		Définir les variables $OA$ et $OB$ ainsi que la fonction $f$.
		\item
