...
\exe{
	...
	\begin{enumerate}
		\item Compléter l'algorithme par dichotomie (figure \ref{fig:2}). Justifier les choix de paramètres initiaux ligne $14$.
		...
		L'approximation de $\sqrt{5}$ déduite est-elle plus ou moins précise que l'approximation de $\phi$ ?
	\end{enumerate}
}{}
