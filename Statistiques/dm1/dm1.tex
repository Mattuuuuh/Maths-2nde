...
\exe{
	...
	\begin{enumerate}
		\item
		Quel est le prix moyen ? Arrondir au centime d'euro.
	\end{enumerate}
...
\exe{
		...
		On compare les prix initiaux avant augmentation aux prix finaux après les deux évolutions successives.
		
		\begin{enumerate}
			\item 
			Quelle augmentation doit-il effectuer pour que les prix ne changent pas, après et avant évolutions ?
			\item
			Quelle augmentation doit-il effectuer pour qu'au final, le prix ait augmenté de $\FINALaug\%$ ?
			\item
			Quelle augmentation doit-il effectuer pour qu'au final, le prix ait diminué de $\FINALdim\%$ ?
		\end{enumerate}
}{}
