...
\exe{
	Remplir approximativement le tableau ci-dessous à l'aide du graphe de $\C_f$.
    ...
    every y tick label/.style={
        ...
        xshift=0.2em,
			...
			\addplot[no marks, blue, -, very thick] expression[domain=-11:-8, samples=50]{5*(x+10)*(x^3 - 300*x - 1920)/80};
			\addplot[no marks, blue, -, very thick] expression[domain=-8:-6, samples=2]{5*(x/2 + 3.2)};
			\addplot[no marks, blue, -, very thick] expression[domain=-6:-5, samples=50]{5*((x+5.5)^2 - 0.5^2 + 0.2)};
			\addplot[no marks, blue, -, very thick] expression[domain=-5:-2.5, samples=2]{5*0.2}
