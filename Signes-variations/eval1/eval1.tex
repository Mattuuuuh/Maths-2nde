...
\exe{[Vrai ou faux]
	...
	\begin{enumerate}
		...
		\item 
		C'est vrai.
		$g$ est produit de deux carrés qui sont toujours positifs et s'annulent en $x=0$ et $x=1$.
		
		\item 
		C'est faux.
		On peut facilement dessiner la courbe d'une fonction qui s'annule en $3$ et $4$ et dont le signe varie.
