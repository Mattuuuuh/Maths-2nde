...
\exe{
	On souhaite connaître les solutions de l'équation du deuxième degré d'inconnue $x\in\R$ :
		\begin{align}
			\eqIa x^2 + \eqIb x \eqIc = 0. \label{eq:1}
		\end{align}
	\begin{enumerate}
		\item Montrer que $\eqIa x^2 + \eqIb x \eqIc = (\aV x^2 - \bV)(\cV - \dV x^2)$.
...
\exe{
	Construire, en posant des nombres réels $a, b, c\in\R$, une équation de la forme
		...
		\end{align}
	telle que l'ensemble des $x\in\R$ solutions de l'équation \eqref{eq:2} soit $\left\{ -\dfrac{7}{12} ; \dfrac{14}{3} \right\}$.
}{}
