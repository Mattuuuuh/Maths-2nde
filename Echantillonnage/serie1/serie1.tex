...
\fancyhead[C]{\textbf{Échantillonnage : dénombrement et probabilités \ifsolutions \, -- Solutions  \fi}}
\fancyhead[R]{\today}
...
# renvoie le nombre de pile après 13 jets de pièce
def jet13():
...
\exe{
	...
	\begin{enumerate}
		...
		\item Comparer $N$ avec la valeur de
			\[ \dfrac{13\times12\times11\times10\times9\times8}{6\times5\times4\times3\times2\times1}. \]
	\end{enumerate}
}{}
