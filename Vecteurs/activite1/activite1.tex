...
\exe{
	...
	\begin{enumerate}
		\item Calculer la norme de $u, v,$ et $w$ et l'écrire sous forme $a\sqrt{b}$ où $a, b\in\N$ et $b$ est le plus petit possible.
		\item Compléter les phrases suivantes.
			\begin{center}
				\og Lorsque le vecteur $u$ est multiplié par $\dots$ pour obtenir $v$, sa norme $\Vert u\Vert$ est multipiée par $\dots$ \fg \\
				\og Lorsque le vecteur $u$ est multiplié par $\dots$ pour obtenir $w$, sa norme $\Vert u\Vert$ est multipiée par $\dots$ \fg
			\end{center}
