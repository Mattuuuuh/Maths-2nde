...
\exe{[$\star$]
	...
	\begin{enumerate}		
		...
		\item
		Conclure que, pour deux fonctions affines $f$ et $g$ quelconques (ne passant pas forcément par l'origine), les droites $\C_f$ et $\C_g$ sont perpendiculaires si et seulement si le produit de leur coefficient directeur vaut $-1$.
