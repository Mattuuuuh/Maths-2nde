...
\exe{
	SITUATION
	Compléter l'arbre et répondre aux questions suivantes.
	\begin{center}
	\begin{tikzpicture}
		% depth 1
		\foreach \i in {-4, 0, 4}
		...
		% depth 2
		\foreach \i in {-4, 0, 4} \foreach \j in {-1, 1}
...
\exe{
	Compléter l'arbre correspondant à une expérience aléatoire à deux épreuves d'univers $\{A ; B ; C ; D ; E ; F\}$ et répondre aux questions suivantes.
	\begin{center}
	\begin{tikzpicture}
		% depth 1
		...
		\draw (3,-4) node[below] {$E$};
		\draw (5,-4) node[below] {$F$};
