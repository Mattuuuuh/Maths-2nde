...
\exe{	
	...
	\begin{tabular}{|c|c|c|c|} \hline
		...
		Fréquence & \ifsolutions $\color{red} 0,33$  & \ifsolutions $\color{red} 0,50$  & \ifsolutions $\color{red} 0,16$  \\ \hline
	\end{tabular}
	\end{center}
...
\exe{	
	...
	\begin{tabular}{|c|c|c|c|c|c|c|} \hline
		...
		Fréquence & \ifsolutions $\color{red} 0,2$ & \ifsolutions $\color{red} 0,3$ & \ifsolutions $\color{red} 0,1$ & \ifsolutions $\color{red} 0,15$ & \ifsolutions $\color{red} 0,2$ & \ifsolutions $\color{red} 0,05$ \\ \hline
	\end{tabular}
	\end{center}
