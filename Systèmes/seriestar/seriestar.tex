...
\exe{
	Montrer que le système suivant d'inconnues $x, y \in \R$ admet exactement quatre solutions : $(x ;y) = (\pm 2 ; \pm 3)$. \footnote{On rappelle la notation $\pm$ qui signifie \og plus ou moins \fg. Par exemple, $\pm3 = 3$ ou $-3$.}
	...
	Donner un système de deux équations non linéaires à inconnues $x, y \in \R$ admettant exactement deux solutions : $(0; \pm1)$.
}{}

\exe{\label{ex:5}
	Montrer que, pour tout $y\in\R$,
		\[ (y+1)^2 + y^2 - 13 = 2y^2 + 2y - 12 = 2(y-2)(y+3). \]

	Montrer que le système suivant d'inconnues $x, y \in \R$ admet exactement trois solutions : $(x ;y) = (0; 2),$ et $(x ;y) = \left( \pm \dfrac12 \sqrt{10} ; -3\right)$.
...
\exe{[$\star$]
	...
	\begin{enumerate}
		...
		\item
		À partir des vecteurs colinéaires $\pvec23$ et $\pvec{-6}{-9}$, construire un système linéaire ayant un nombre infini de solutions.
		
		\item
		À partir des vecteurs colinéaires $\pvec23$ et $\pvec{-6}{-9}$, construire un système linéaire n'ayant aucune solution.
	\end{enumerate}
}{}
