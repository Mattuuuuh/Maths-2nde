...
\begin{multicols}{3}
	...
	L'instruction \texttt{return} permet de renvoyer une valeur.
...
\begin{multicols}{2}
	La précision étant finie, la comparaison peut renvoyer \texttt{False} par erreur d'approximation.
	
	Pour éviter ce problème, il peut être pertinent de vérifier que deux valeurs sont proches plutôt qu'égales.
	Par exemple, on peut vérifier que la distance entre $x$ et $y$ est plus petite que $0,001$ au lieu que $x = y$.
