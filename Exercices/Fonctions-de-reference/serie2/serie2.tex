...
\exe{
	Montrer que si $f$ est impaire, alors $f(0) = 0$.
}{}
...
\exe{[$\star$]
	Trouver un polynôme $f$ de degré 3\footnote{C'est-à-dire $f(x) = ax^3 + bx^2 + cx + d$ pour certains coefficients $a, b, c, d \in \R$. Le degré est la plus haute puissance de $x$.} par interpolation de Lagrange tel que 
		\begin{align*}
			f(1) = 3, && f(2) = 4, && f(3) = 5, && f(4) = 12.
		\end{align*}
	Vérifier que $f(x) = x^3 -6x^2 + 12x - 4$ fonctionne.
}{}
