...
\exe{, difficulty=1}{
	...
	Montrons que $\C_f$ n'est pas une droite en exhibant trois points lui appartenant qui ne sont pas alignés.
		...
		\end{itemize}
	Les vecteurs $\vec{AB}$ et $\vec{AC}$ ne sont pas colinéaires.
		\begin{align*}
			\vec{AB} = \pvec{1-0}{4-1} = \pvec13 && \et && \vec{AC} = \pvec{2-0}{9-1}=\pvec28
		\end{align*}
	Les vecteurs ne sont pas colinéaires car si $\vec{AC}=k\vec{AB}$ alors, en abscisse, le seul multiple possible est $k=2$, et en ordonnée, leur seul multiple possible est $k=\frac83 \neq 2$.
	On peut aussi utiliser que leur déterminant n'est pas nul.
