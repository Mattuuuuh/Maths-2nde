...
\exe{}{
	Parmis les premiers de l'exercice \ref{exe:premiers}, lequels admettent un nombre premier de lettres lorsque écrits en toutes lettres ?
}{exe:premier-premier}{
...
\exe{}{
	\begin{enumerate}
		...
		\item Simplifier la fraction $\frac{6}{15}$ comme {fraction irréductible}.
	\end{enumerate}
}{exe:old-div4}{
...
\exe{}{
	\begin{enumerate}
		...
		\item Écrire la somme $\frac{3}{10} + \frac{6}{35}$ comme {fraction irréductible}.
	\end{enumerate}
}{exe:old-div5}{
	\begin{enumerate}
...
\exe{}{
	Écrire les nombres rationnels suivants comme fraction irréductible.
	\begin{multicols}{4}
	\begin{enumerate}[label=\alph*)]
		\item $\dfrac{3}{44}$
		\item $\dfrac{14}{27}$
...
\exe{, difficulty=2}{
	...
	\begin{enumerate}
		...
		\item
		Montrer que pour pour tout $q\in\R$ et $d\geq1$ entier,
			\[ (q-1)(1+q+q^2 + q^3 + \cdots + q^{d-1}) = q^d - 1. \]
		\item
