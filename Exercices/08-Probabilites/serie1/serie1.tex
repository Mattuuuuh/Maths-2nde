...
\exe{}{
	...
	\begin{enumerate}
		\item
		Les deux issues sont « Rouge » et « Noir ».
		\item 
		On s'attend à avoir tiré 20 000 fois « Noir » et 30 000 fois « Rouge ».
		\item 
		La probabilité d'obtenir « Rouge » est $\frac35$ et la probabilité d'obtenir « Noir » est $\frac25$.
	\end{enumerate}
}
...
\exe{}{
	...
	\begin{enumerate}
		...
		\columnbreak
		\item C : « le nombre est multiple de $3$ \textbf{ou} pair »
		\item D : « le nombre est multiple de 3 \textbf{et} pair »
		\end{enumerate}
		\end{multicols}
	\end{enumerate}
}{exe:exe1}{
...
\exe{}{
	On suppose le D20 de l'exercice \ref{exe:exe1} bien équilibré.
	\begin{enumerate}
		\item 
...
\exe{}{
	On lance un D$300$ bien équilibré, dé à $300$ faces numérotées de $1$ à $300$.
...
\exe{}{
	...
	\begin{enumerate}
		...
		\begin{enumerate}
			...
			\item
			La probabilité de tirer une boule blanche lorsque l'on tire dans l'urne 1.
			\item
			La probabilité de tirer une boule rouge lorsque l'on tire dans l'urne 1.
			\item
			La probabilité de tirer une boule noire lorsque l'on tire dans l'urne 2.
		\end{enumerate}
		\item
...
\exe{, difficulty=1}{
	...
	\begin{enumerate}
		...
		La feuille qui correspond à « obtenir aucun double $6$ » est obtenue en obtenant « pas double 6 » dix fois dans l'arbre.
...
\exe{, difficulty=3}{
	...
	Notons $X$ le numéro de « face » obtenus avant le premier « pile ».
	\begin{multicols}{2}
	\begin{enumerate}
		\item
