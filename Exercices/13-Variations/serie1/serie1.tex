...
\exe{,difficulty=1}{
	...
	Esquisser la courbe de chaque fonction suivante puis remplir son tableau de variations.
		\begin{multicols}{4}
...
%		\item Esquisser, dans le même repère, la courbe de $k(x) = -f(x)$.
%		\item Esquisser, dans le même repère, la courbe de $\ell(x) = 2f(x)$.
%		%\item Remplir le tableau de variations ci-dessous.
%	\end{enumerate}
