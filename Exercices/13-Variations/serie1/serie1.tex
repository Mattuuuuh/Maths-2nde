...
\exemulticols{}{
	...
	\begin{axis}[xmin = -3, xmax=3, ymin=-1.5, ymax=5.5, y=25pt, axis x line=middle, axis y line=middle, axis line style=->, xlabel={}, ylabel={}, xtick distance = 1, ytick distance=1, grid=both]
		...
		% trouvée par Thomas C. et Meryam B.
	\end{axis}
	\end{tikzpicture}
	\end{center}
}{exe:aut0}{
...
\exe{}{
	...
	\end{tikzpicture}
	\end{center}
	Remarque : le maximum et le minimum font partie des images du tableau. 
	Ils ont atteints soit aux bornes du domaine, soit lors d'un changement de variations de la fonction.
	Par exemple, le minimum de $g$ est $-2$ (atteint en deux antécédents différents), et le maximum de $g$ est $2$.
}
