...
%\begin{namedtheorem}[Simplification]
	On suppose que le prix est un nombre entier entre 0€ et 1 000€ inclus.
%\end{namedtheorem}
...
\subsubsection*{Stratégie de dichotomie}
...
%\begin{namedtheorem}[Problème de recherche de zéro]
	...
	d'amplitude $b-a$ inférieure à la précision fixée ?
%\end{namedtheorem}
...
\begin{multicols}{2}
	...
	\begin{namedtheorem}[Hypothèses]\
		\begin{itemize}
			...
			\item
			$f$ est croissante autour de sa racine.% (on peut prendre $-f$ dans le cas contraire).
			\item
