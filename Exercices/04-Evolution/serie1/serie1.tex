...
\exe{}{
	...
	Arrondir les coefficients multiplicateurs au dixième avant de donner les évolutions correspondantes.
	\begin{enumerate}
...
\begin{center}
	\begin{tikzpicture}
		...
		% vertices		
		\draw[->, very thick, RED_E] (1cm,-.5cm) arc (-105:-75:15) node[midway, below] {$\times1,44$};
		\draw[->, very thick, RED_E] (8.75cm,.5cm) arc (75:105:15) node[midway, above] {$\times0,7$ environ};
	\end{tikzpicture}
\end{center}
}
...
\exe{, difficulty=2}{
	...
	Supposons que la proportion d'éléments de $E$ appartenant à $A$ est de 30\% et que la proportion d'éléments de $E$ appertenant à $B$ est de 20\%.
	...
	\begin{enumerate}
		\item
		Comptons le nombre d'éléments de $E$ qui appartienne à $A$ ou à $B$ en énumérant les éléments de $A$ puis les éléments de $B$.
		D'après l'énoncé, nous avons énuméré $0,3 |E|$ et $0,2 |E|$ éléments respectivement.
		Cependant, les éléments appartenant à la fois à $A$ et à $B$ ont été comptés en double : il faut donc soustraire $0,1 |E|$ au compte pour conclure :
