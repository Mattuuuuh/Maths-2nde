...
\exe{, difficulty=1}{
	...
	\begin{enumerate}
		...
		Par exemple, pour obtenir une erreur absolue de $10~000$, il faut prendre $x=\frac{10~000}{0,003} \approx 3~333~334$.
...
\exe{, difficulty=2}{
	...
	\begin{enumerate}
		...
		\item
		Procédons exactement de la même manière. En notant $N$ le nombre d'éléments appartenant à la fois à $A$ et à $B$,
			\begin{align*}
