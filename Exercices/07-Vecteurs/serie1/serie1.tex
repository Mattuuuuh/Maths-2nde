...
\exe{, difficulty=1}{
	...
	Les vecteurs ne sont pas colinéaires : s'il existait un $k\in\R$ tel que $\vec{AB} = k \vec{CD}$, on aurait nécessairement $k=-1$ par la première coordonnée, et $k=-\frac53 \neq -1$ par le seconde.
...
\exe{, difficulty=1}{
	...
	Ces deux vecteurs ne sont pas colinéaires car s'ils l'étaient, on aurait un $k \in \R$ tel que
		\[ \vec{AB} = k \vec{CD}, \]
	ce qui donnerait $k = -1$ en étudiant la première coordonnée, et $k=-\frac45$ en regardant la deuxième.
	...
	Le parallélisme des deux autres côtés se montre de la même manière.
}
