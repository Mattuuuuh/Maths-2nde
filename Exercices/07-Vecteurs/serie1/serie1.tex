...
\exe{}{
	...
	\begin{enumerate}
		\item Compléter les phrases suivantes.
			\begin{center}
				\og Lorsque le vecteur $u$ est multiplié par $\dots$ pour obtenir $v$, son sens $\dots\dots\dots\dots\dots\dots$ \fg \\ \vspace{10pt}
				\og Lorsque le vecteur $u$ est multiplié par $\dots$ pour obtenir $w$, son sens$\dots\dots\dots\dots\dots\dots$ \fg\\ \vspace{10pt}
		...
		\item Compléter les phrases suivantes.
			\begin{center}
				\og Lorsque le vecteur $u$ est multiplié par $\dots$ pour obtenir $v$, sa norme $\Vert u\Vert$ est multipliée par $\dots$ \fg \\ \vspace{10pt}
				\og Lorsque le vecteur $u$ est multiplié par $\dots$  pour obtenir $w$, sa norme $\Vert u\Vert$ est multipliée par $\dots$ \fg \\ \vspace{10pt}
...
%			\[\Vert \kappa \cdot u \Vert = | \kappa | \cdot  \Vert u \Vert. \]
	...
	\begin{enumerate}
		\item
			\begin{center}
				\og Lorsque le vecteur $u$ est multiplié par {\color{myr} $2$} pour obtenir $v$, son sens {\color{myr} ne change pas} \fg \\ \vspace{10pt}
				\og Lorsque le vecteur $u$ est multiplié par  {\color{myr} $-\dfrac32$} pour obtenir $w$, son sens {\color{myr} change} \fg\\ \vspace{10pt}
				\og Lorsque le vecteur $u$ est multiplié par  {\color{myr} $-\dfrac12$} pour obtenir $z$, son sens {\color{myr} change} \fg
			\end{center}
		\item
			\begin{align*}
		...
		\item
			\begin{center}
				\og Lorsque le vecteur $u$ est multiplié par {\color{myr} $2$} pour obtenir $v$, sa norme $\Vert u\Vert$ est multipliée par {\color{myr} $2$} \fg \\ \vspace{10pt}
				\og Lorsque le vecteur $u$ est multiplié par {\color{myr} $-\dfrac32$} pour obtenir $w$, sa norme $\Vert u\Vert$ est multipliée par {\color{myr} $\dfrac32$} \fg \\ \vspace{10pt}
				\og Lorsque le vecteur $u$ est multiplié par {\color{myr} $-\dfrac12$} pour obtenir $z$, sa norme $\Vert u\Vert$ est multipliée par {\color{myr} $\dfrac12$} \fg
			\end{center}
%		\item
...
\exe{, difficulty=1}{
	Considérons les vecteurs $u = \pvec{2t}{3-t}$ et $v = \pvec{-1}{3+t}$ dépendant d'un paramètre $t\in\R$.
	\begin{enumerate}
		\item
		Montrer que $\det(u, v) = 3 + (t-1)^2$.
		\item
		Justifier que $\det(u, v) \geq 3$ pour tout $t\in\R$.
		\item
...
\subsubsection*{Approfondissements}

\exe{, difficulty=3}{
	On dit de deux vecteurs $u, v$ qu'ils sont orthogonaux dès que les droites $(OU)$ et $(OV)$ où $U = O + u$ et $V = O + v$ sont perpendiculaires.
	
	Soient $u = \pvec{a}{b}, v = \pvec{x}{y}$ deux vecteurs orthogonaux.
	\begin{enumerate}
		\item
		Faire un dessin dans lequel doivent figurer : l'origine $O$ d'un repère ; deux points $U$ et $V$ tels que $(OU) \perp (OV)$ ; le point $W$ tel que $OVWU$ est un rectangle.
		\item
		...
		\item
		En conclure que l'aire du rectangle $OVWU$ est donné par $|\det(u, v)|$.
	\end{enumerate}
