...
\exe{, difficulty=3}{
	Cet exercice généralise l'exercice \ref{exe:Pyth} et vise à donner une condition simple d'orthogonalité, ainsi que faire le lien entre le déterminant et l'aire d'un parallélogramme appelé \emph{parallélogramme fondamental}.
