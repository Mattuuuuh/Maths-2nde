...
\exe{
	...
	\begin{enumerate}
		\item 
		La variable ici est la température en °C.
		D'après les mesures, les points $(100 ;212), (-10;14), (10,50), (-50;-58)$ appartiennent à la courbe représentative de $F$.
		
		Nommons $A=(-10;14)$ et $B=(-50;-58)$ et utilisons la stratégie d'interpolation.
		D'abord
			\[ a = \dfrac{-58 - (14)}{-50-(-10)} = \dfrac{-72}{-40} = \dfrac{72}{40} = \dfrac95. \]
...
\exe{
	...
	\begin{enumerate}
        ...
        \item À la minute $10+t$, où $t\geq0$, on appelle $A(t)$ et $T(t)$ les distances parcourues respectivement par Achille et la tortue.
        Montrer que
            \begin{align*}
	...
	\begin{enumerate}
        \item
        	La tortue avant dix fois moins vite, donc à $6$ mètres par minute.
        	En $10$ minutes, elle parcourt donc $6\cdot10 = 60$ mètres.
	\item
		On multiplie une vitesse par un temps pour obtenir une distance : $v \times t = d \iff v  = \dfrac{d}{t}$.
		
		Au temps $10+t$, Achille aura couru pendant $t$ minutes, et sa distance sera donc de $A(t) = 60 t$.
		Idem pour la tortue, sauf qu'elle court pendant l'intégralité des $10+t$ minutes, et donc $T(t)= 6(10+t) = 60 +6t$.
	\item
		Soit $t^\star$ le temps qu'Achille met pour rattraper la tortue.
		Ce temps correspond au moment où Achille et la tortue ont parcouru la même distance, c'est-à-dire
			\[ A(t^\star) = T(t^\star). \]
		On résoud cette équation pour $t^\star$, qui donne
			\begin{align*}
				60 t^\star &= 60 + 6 t^\star, \\
				(60-6) t^\star &= 60, \\
				54 t^\star &= 60, \\
				t^\star &= \dfrac{60}{54} = \dfrac{10}9.
			\end{align*}
		Achille met donc $\dfrac{10}9$ minutes à rattraper la tortue.
