...
\exe{}{
	...
	D'après la formule de la longueur, on trouve les distances suivantes.
		\begin{align*}
			AB^2 &= \bigl(2-(-1)\bigr)^2 + (3-3)^2 = 9 \\
			CD^2 &= \bigl(0- (-1)\bigr)^2 + (-5-0)^2 = 1 + 25 = 26 \\
			EF^2 &= (-2-4)^2 + (-1-1)^2 = 36 + 4 = 40
		\end{align*}
}
...
\exe{}{
	...
	Les diagonales sont données par $[BC]$ et $[AD]$.
	D'après la formule, le milieu de $[BC]$ a pour coordonnées $(-1 ; -1)$, et le milieu de $[AD]$ a pour coordonnées $(-1 ; -1)$.
	$BACD$ est donc un parallélogramme.
}
