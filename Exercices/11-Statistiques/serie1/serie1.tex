...
\exe{}{
	Chaque jour du mois d'avril 2026, le meilleur ami de Lucile relève la distance qu'il a parcourue lors de son footing.
	\begin{center}
\def\arraystretch{1}
...
\setlength\tabcolsep{15pt}
		...
		\begin{enumerate}
			\item
			Compléter la ligne « Écart » avec les écarts de chaque distance à la moyenne.
			\item
...
\exe{}{
	...
	Faire une phrase de comparaison des deux séries statistiques en identifiant ce qui les distingue.
}{exe:8}{
