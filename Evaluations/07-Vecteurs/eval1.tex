...
\exe{5}{
	...
	\begin{enumerate}
		\item 
		Identifier les erreurs de commises. Il y en a au moins 3 différentes.
		\item
		Répondre à l'énoncé en justifiant.
	\end{enumerate}
}{exe:erreurs}{
	\begin{enumerate}
		\item
		La première ligne de calculs contient deux erreurs : la formule est fausse ($x_B - x_A$ et non $x_A - x_B$) ; et le calcul $-1-(-3)$ vaut $-1+3 = 2$ et non 4.
		
		La deuxième ligne de calculs contient également deux erreurs de signe : $5-(-1) = 5+1 = 6$ et $12-(-6) = 18$.
		
		La troisième ligne de calculs utilise la formule $ad+bc$ qui n'est pas la bonne formule du déterminant $ad-bc$.
	...
	\begin{enumerate}
		...
		Calculons le carré de la longueur de chaque côté :
			\begin{align*}
				...
				BC^2 = \Vert \vec{BC} \Vert^2 = \left\Vert \dfrac17\pvec{20}{-25} \right\Vert^2 = \dfrac{20^2 + 25^2}{7^2} = \dfrac{1025}{49}.
			\end{align*}
