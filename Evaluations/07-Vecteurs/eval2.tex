...
\exe{10}{
	...
	\begin{enumerate}[resume]
		...
		\begin{enumerate}[label=(\alph*)]
			...
			À droite, $AB^2 + AD^2 = \norm{\vec{AB}}^2 + \norm{\vec{AD}}^2 = \left(2\sqrt{10}\right)^2 + \left(\sqrt{10}\right)^2 = 4\times10 + 10 = 50$.
			...
			Par conséquent, l'aire est donnée par $AB \times AD = \norm{\vec{AB}} \times \norm{\vec{AD}} = 2 \sqrt{10} \times \sqrt{10} = 2 \times 10 = 20$.
