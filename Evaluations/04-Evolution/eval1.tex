...
\exe{2, difficulty=1}{
	...
	La proportions de filles inscrites en STMG peut être vue comme la proportion d'élèves en STMG multipliée par la proportion $p$ de filles parmis les STMG.
