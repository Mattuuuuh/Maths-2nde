...
\exe{6}{
	...
	\end{enumerate}
	À l'aide de la loi $P$ définie, répondre aux questions suivantes.
...
\exe{5, difficulty=1}{
	...
	D'après le principe d'inclusion-exclusion, 
		\[ |A \cup B| = |A| + |B| - |A \cap B|, \]
	car en comptant les éléments appartenant à $A$ et les éléments appartenant à $B$ en faisant $|A| + |B|$, on compte les éléments appartenant à la fois à $A$ et à $B$ deux fois.
	
	L'ensemble $A\cap B$ est l'ensemble des entiers entre 1 et 1 000 qui sont multiples à la fois de 3 et de 5.
	Ces entiers admettent donc un 3 et un 5 dans leur décomposition en facteurs premiers, il s'écrivent donc $3\times5\times\cdots = 15\times\cdots$.
