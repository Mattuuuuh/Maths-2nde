...
\exe{, difficulty=2}{
	...
	\begin{enumerate}
		...
		\item En déduire que
			$  \left|\sqrt2 -  \dfrac{p}{q} \right| \geq \dfrac{1}{4q^2}. $
	\end{enumerate}
}{exe:qapprox-sqrt2}{
	TODO
}
...
\exe{, difficulty=2}{
	...
	Montrer qu'il existe nécessairement deux entiers naturels $0\leq m<n\leq N$ tels que $|nx - mx|$ ait une partie décimale comprise entre $0$ et $\dfrac1N$.
