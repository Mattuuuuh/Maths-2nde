...
\exe{}{
	...
	\begin{center}
	\includegraphics[page=18]{figures/fig-geom.pdf}
	\end{center}
}{exe:proj2}{
	TODO
}
...
\exe{, difficulty=2}{
	...
	Considérons donc le triangle $ABC$ de l'exercice \ref{exe:formule-aire}.
...
\exe{, difficulty=1}{
	Soit un triangle aux angles $\alpha, \beta, \gamma$ opposés au côtés de longueur $a, b, c$.
