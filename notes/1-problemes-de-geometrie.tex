...
\exe{, difficulty=1}{
	Soit un cercle de centre $O$ et une droite tangente au cercle, c'est-à-dire qui ne le touche qu'en un seul point $P$.
	Montrer que la droite $(OP)$ est perpendiculaire à la tangente.
}{exe:tangente-perp}{
	TODO
}
