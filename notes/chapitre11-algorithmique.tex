...
\dfn{Système de deux équations}{
	Un \emph{système} de deux équations linéaires à deux inconnues réelles, notées $x$ et $y$, s'écrit sous la forme
...
\dfn{Équations équivalentes, systèmes équivalents}{
	...
	Un système d'équations est équivalent à un autre si, pour passer de l'un à l'autre, on a remplacé certaines équations par des équations équivalentes.
}{}
