...
\ex{Racine carrée de $7$}{
	...
	\end{subfigure}
	%\end{center}
	\caption{Les quatre premières étapes de l'algorithme de recherche de la racine positive de $f(x) = x^2 - 7$ en commençant avec l'intervalle $[2 ; 3]$. On en déduit que $\sqrt{7} \in [m_3 ; m4] = [2,625 ; 2,6875]$. }
