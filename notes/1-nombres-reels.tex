...
\dfn{nombres rationnels}{
	...
	Alors le \emphindex{rationnel} $\frac{a}{b}$ est l'unique nombre tel que
		\[ \dfrac{a}b \times b = a. \]
...
\ex{}{
	Le nombre rationnel $\frac13$ est l'unique nombre vérifiant
		\[ \dfrac13 \times 3 = 1. \]
...
\pf{}{
	...
	Or $\frac{10}7 = 1 + \frac37$, donc $n_1 = 1$ et
	...
	En $8$ étapes, deux parties décimales identiques sont rencontrées, et donc $\frac17$ est périodique.
}
