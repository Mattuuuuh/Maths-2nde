...
\exe{, difficulty=2}{
	...
	\begin{enumerate}
		...
		Alors $10^n x$ et $10^{n+p}x$ admettent le même développement décimal.
		La différence $10^{n+p} x - 10^n x = (10^{n+p} - 10^n)x$ est donc un entier.
		Par division par $10^{n+p}-10^{n}$, $x$ est rationnel.
	\end{enumerate}
}
