...
\exe{, difficulty=2}{
	À l'aide de l'exercice \ref{exe:diff-carrés}, montrer que la somme des $n+1$ premiers nombres impairs est un carré parfait. Plus précisément,
	...
	Plus précisément, on a les différences suivantes :
		\begin{align*}
			1^2 - 0^2 &= 1 \\
			2^2 - 1^2 &= 3 \\
			3^2 - 2^2 &= 5 \\
...
\nt{
	...
	Cependant, les outils présentés dans ce chapitre permettent déjà de le démontrer.
}
