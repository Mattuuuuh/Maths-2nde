...
\begin{multicols}{2}
\ex{}{
	On considère la droite $y=ax+b$ ci-contre.
...
\exe{}{
	Considérons deux droites $(d)$ et $(d')$ données par
		\begin{align*}
			(d) &= \bigset{ (x,y) \text{ tq. } x,y\in\R \text{ et } y = 2x+1 }, \\
			(d') &= \bigset{ (x,y) \text{ tq. } x,y\in\R \text{ et } y = 2x-2 }.
		\end{align*}
...
\ex{}{
	Soit $(d)$ une droite donnée par
		\[ (d) = \bigset{ (x,y) \text{ tq. } x,y\in\R \text{ et } y = 2x+3 }. \]
	...
	En conclusion, $f(x) = 2x - 3$, et la droite recherchée est donnée par (en violet ci-dessous)
		\[ \bigset{ (x,y) \text{ tq. } x,y\in\R \text{ et } y = 2x-3 }. \]
