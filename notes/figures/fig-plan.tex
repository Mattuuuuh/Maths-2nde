...
%
	...
	% page 5
	\begin{tikzpicture}[>=stealth, scale=1]
		\begin{axis}[xmin = -1.5, xmax=3.5, ymin=-9.5, ymax=6.5, ytick = {-9, ..., 7}, axis x line=middle, axis y line=middle, axis line style=<->, xlabel={}, ylabel={}, grid=both, x=2cm, grid style = {opacity=.5}]
