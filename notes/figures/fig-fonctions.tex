	...
	% page 1
		...
		\begin{tikzpicture}[>=stealth]
			...
			grid style = {opacity=.5},
				...
				\draw[PURPLE, dotted, very thick] (axis cs:1.2, -.85) -- (axis cs:1.2,3);
				\addplot[RED_E, dotted, very thick, domain = 0:1.2, samples=2] {3};
				\addplot[RED_E, dotted, very thick, domain = 0:1.2, samples=2] {-.85};
	...
	% page 8
		...
		\begin{tikzpicture}[>=stealth]
			...
			x=2cm,
				...
				\addplot[no marks, BLUE_E, very thick, -] expression[domain=-4:3, samples=200]{x^3 /3 - 2*x +3}node[pos=.5, right]{$\C_f$};
			\end{axis}
		\end{tikzpicture}
		%page 10
