...
\exe{, difficulty=2}{
    Soit l'ensemble d'entiers $E=\bigset{n; n+1; \dots; m-1 ; m}$ dépendant de deux entiers relatifs $n<m$.
    Calculer $|E|$ en fonction de $n$ et $m$.
    Vérifier la formule avec $n=-1$ et $m=1$ en sachant que $\bigl|\bigset{-1 ; 0 ; 1 }\bigr| = 3$.
}{exe:evol13}{
	On soustrait $n$ à chaque élément de $E$, ce qui ne change pas le cardinal mais a l'avantage de simplifier l'ensemble.
		\[ |E| = \bigset{ 0; 1 ; \dots ; m-n }. \]
