...
\exe{, difficulty=1}{
	...
	\begin{enumerate}
		...
		\item En écrivant $x = 2k+1$ pour un entier $k\in\Z$, montrer que $y=3k+1$.
...
\exe{, difficulty=2}{
	Déduire de l'exercice \ref{exe:sum-odd} que n'importe quelle somme de plus de deux impairs consécutifs n'est jamais un nombre premier.
}{exe:odd-nonprime}{
