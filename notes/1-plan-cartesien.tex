...
\exe{}{
	...
	Calculer les carrés de chacun des côtés. Que dire du triangle ?
}{exe:Trex}{
	TODO
}
...
\exe{}{
	...
	Représenter le point
		\[ \lambda A + (1-\lambda)B, \]
	pour certaines valeurs de $\lambda$ entre 0 et 1.
...
\thm{}{
	...
	Alors le milieu $M$ du segment $[AB]$ est $M = \dfrac{A+B}{2}.$
...
\pf{}{
	Le point $P = \dfrac12 A + \dfrac12 B$ appartient au segment $[AB]$ (en prenant $\lambda=\frac12$), et vérifie
		\begin{align*}
	...
	Le point $P$ est donc à équidistance de $A$ et $B$ et c'est le milieu du segment : $M = P = \dfrac{A+B}2$.	
}{}
